...
| GCP API edge | IN_PROGRESS | Gateway API and HTTPRoute skeleton created for `/api/**` routes; Identity route now targets service port `8081`. Cloud LB is not provisioned yet. | `../../k8s/base/edge/`, `../../docs/evidence/k8s-identity-access/2026-06-04-identity-kustomize-validation.md` | 2026-06-04 |
