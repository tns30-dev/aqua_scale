...
| Argo CD rollout | DONE | Argo CD synced the private GitHub repo at revision `960e98f88c697952977b63f933a5ae7ff5ba5bd2`, targets `k8s/overlays/dev-managed-public`, and reports `Synced/Healthy`. | `../main/cd.md`, `../main/gke.md`, `../../k8s/argocd/aquashield-dev-application.yaml`, `../../docs/evidence/gitops/2026-06-05-argocd-dev-managed-rollout.md`, `../../docs/evidence/public-edge/2026-06-05-public-edge-live-rollout.md` | 2026-06-05 |
...
| Demo evidence | IN_PROGRESS | Managed runtime smoke, AWS IoT/Lambda live smoke, public HTTPS API edge live smoke, Firebase Hosting custom-domain live deploy, CI/SAST recovery, and HTTPS static-IP reservation evidence are recorded. DAST and performance evidence remain. | `../../docs/evidence/` | 2026-06-05 |
