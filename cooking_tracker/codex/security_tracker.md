...
| Firebase frontend HTTPS | PASS; default Firebase Hosting URL returns HTTP/2 200 with HSTS. Custom `www.aquashield.live` DNS is correct but certificate activation remains pending. | 2026-06-05 |
...
| 2026-06-05 | Deployed Firebase Hosting over HTTPS on the default site and configured `www.aquashield.live` DNS; DAST waits for the custom frontend certificate to become active. |
