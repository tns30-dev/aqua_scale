...
- Next test: Install Istio CRDs/control plane, then prove mTLS and AuthorizationPolicy behavior on the live cluster before post-deploy DAST.
...
| 2026-06-05 | Runtime GKE/network foundation went live. Cloud Armor remains design-only for this implementation, and mesh proof is gated by Istio installation. |
