...
- Current focus: Kustomize/GKE platform skeleton created in `aquashield/deploy/k8s`.
...
| Kubernetes NetworkPolicy | IN_PROGRESS | Base default-deny ingress and GCLB allow policy created; service-specific allow policies pending service deployments. | `../../aquashield/deploy/k8s/base/network/` | 2026-06-04 |
| Istio service mesh | IN_PROGRESS | Namespace mesh labels, strict mTLS, and namespace default-deny AuthorizationPolicy created; service-specific allow policies pending. | `../../aquashield/deploy/k8s/base/mesh/` | 2026-06-04 |
| Namespaces | IN_PROGRESS | Dev and staging namespace manifests created; not applied to a live cluster yet. | `../../aquashield/deploy/k8s/overlays/dev/namespace.yaml`, `../../aquashield/deploy/k8s/overlays/staging/namespace.yaml` | 2026-06-04 |
...
|---|---|---|
| `kubectl kustomize deploy/k8s/overlays/dev` | PASS | 2026-06-04 |
| `kubectl kustomize deploy/k8s/overlays/staging` | PASS | 2026-06-04 |
