...
| [x] | Claude | Analytics Service | TypeScript/Express chart API with Bigtable/BigQuery read paths | `analytics_service.md` |
| [x] | Claude | Audit Service | Java append-only audit consumer and query path | `audit_service.md` |
